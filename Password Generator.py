...
#passwordword Generator
#https://www.codementor.io/ilyaas97/6-python-projects-for-beginners-yn3va03fs#passwordword-generator
...
num="0123456789"
sym="!#$%&()*+-./:;<=>?{|}"
l=input("Enter the passwordwords size : ")
if l<6:
